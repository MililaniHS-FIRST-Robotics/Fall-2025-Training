...
public class PivotUpCommand extends Command{
    ...
    public PivotUpCommand(PivotSubsystem pivotSubsystem, GenericHID controller){
...
//set the setpoint
        pivotSubsystem.motorSetPoint(60);
    }
    @Override
    public void execute(){
    ...
    public boolean isFinished(){
        return !controller.getRawButton(Constants.GamepadConstants.kDpadUp); //placeholder //whatever button you set this to
    }
}
